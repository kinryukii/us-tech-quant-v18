...
| VALIDATION_FAIL_COUNT | 1 | Validation errors in current daily chain. | Zero is preferred; non-zero would lower trust. |
...
| DAILY_THRESHOLD_COVERAGE_SOURCE_MODIFIED_TIME | 2026-05-25T18:48:06 | Filesystem modified time for selected coverage source. | Newest valid daily-threshold evidence is selected. |
...
| PRICE_PREFLIGHT | FAIL | Historical yfinance/caching preflight result. | FAIL indicates provider or cache repair issues were seen. |
