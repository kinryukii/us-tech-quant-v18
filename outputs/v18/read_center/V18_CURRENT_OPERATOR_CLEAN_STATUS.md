...
| FIXABLE_CURRENT_WARNING | V18_38C_R1 UNKNOWN_REVIEW_COUNT | 15 | FIXABLE_CURRENT_WARNING | FALSE | Unknown current review items should be triaged. |
...
| STALE_SUPPORTING_REPORT | V18_38C_R1 CURRENT_REPORT_STALE_WARN_COUNT | 2 | STALE_SUPPORTING_REPORT | FALSE | Supporting report stale warning is fixable but not a daily-run blocker. |
| HISTORICAL_LEGACY_ONLY | V18_38C_R1 legacy issue counters | 468 | HISTORICAL_LEGACY_ONLY | FALSE | Historical/legacy findings never make DAILY_RUN_USABLE false. |
