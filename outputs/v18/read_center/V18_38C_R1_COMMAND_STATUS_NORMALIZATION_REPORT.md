...
## 3. 历史旧问题与当前问题的区分
- HISTORICAL_LEGACY 数量: 232
- UNKNOWN_LEGACY 数量: 38
...
## 6. 需要之后处理的问题
- V18_19A_READ_FIRST.txt [CURRENT_CRITICAL]: DATA_PROVIDER_WARN - Current data provider, yfinance, preflight, or price-cache warning
...
- V18_35F_READ_FIRST.txt [CURRENT_CRITICAL]: REVIEW_NEEDED_NON_BLOCKING - Current WARN_ status needs operator review
...
- V18_CURRENT_CHINESE_DAILY_HOMEPAGE.md [CURRENT_SUPPORTING]: REPORT_STALE_WARN - Current supporting report does not appear to be generated today
...
- V18_CURRENT_FULL_UNIVERSE_RECOMPUTE.md [CURRENT_SUPPORTING]: REPORT_STALE_WARN - Current supporting report does not appear to be generated today
...
- V18_CURRENT_ALPHA_SIGNAL_OBJECTS.md [UNKNOWN_LEGACY]: ACCOUNT_TEMPLATE_WARN - Account template or account-state quality warning
- V18_CURRENT_DAILY_OPERATOR_RUNBOOK_CN.md [UNKNOWN_LEGACY]: ACCOUNT_TEMPLATE_WARN - Account template or account-state quality warning
- V18_CURRENT_MANUAL_ACCOUNT_STATE_GUIDE.md [UNKNOWN_LEGACY]: ACCOUNT_TEMPLATE_WARN - Account template or account-state quality warning
- V18_CURRENT_PORTFOLIO_TARGET_PREVIEW.md [UNKNOWN_LEGACY]: ACCOUNT_TEMPLATE_WARN - Account template or account-state quality warning
- 另有 1 项未展开，详见 detail CSV。
