...
- RUN_ID: `V18_35A_20260525_141108`
- GENERATED_AT: `2026-05-25T14:11:08`

## 一句话结论
当前 rolling universe 总池为 `318`，current ranked candidates 为 `318`，总池中未进入当前候选池为 `0`。
