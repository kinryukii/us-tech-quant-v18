...
Write-Host "=== V18.23A ROLLING RESEARCH COVERAGE CONTROLLER START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: READ_ONLY_ROLLING_RESEARCH_COVERAGE_PLANNING"
...
$Script = Join-Path $Root "scripts\v18\v18_23A_rolling_research_coverage_controller.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_23A_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.23A rolling coverage controller Python script: $Script"
}
...
Write-Host "=== V18.23A READ_FIRST CONTENT ==="
...
Write-Host "=== V18.23A ROLLING RESEARCH COVERAGE CONTROLLER END ==="
exit 0
