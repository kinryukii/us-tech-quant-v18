...
Invoke-Step -StepOrder 3 -StepName "V18.4D_FACTOR_PACK_AUDIT" -ScriptPath $V18_4D

Invoke-Step -StepOrder 4 -StepName "V18.4E_FACTOR_OUTPUT_FORWARD_AUDIT" -ScriptPath $V18_4E
