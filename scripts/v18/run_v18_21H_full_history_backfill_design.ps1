...
Write-Host "=== V18.21H FULL HISTORY BACKFILL DESIGN START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: ADVISORY_DRYRUN_ONLY"
Write-Host "PATCH_MODE: FULL_HISTORY_BACKFILL_DESIGN_ONLY"
...
$Script = Join-Path $Root "scripts\v18\v18_21H_full_history_backfill_design.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21H_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21H_CURRENT_FULL_HISTORY_BACKFILL_DESIGN_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21H full history backfill design Python script: $Script"
}
...
Write-Host "=== V18.21H FULL HISTORY BACKFILL DESIGN END ==="
