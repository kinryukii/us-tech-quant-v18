...
Write-Host ""
Write-Host "=== V18.6F-R2 STABLE SNAPSHOT START ==="
Write-Host "ROOT: $Root"

Set-Location $Root

$Stamp = Get-Date -Format "yyyyMMdd_HHmmss"
$SnapshotName = "V18_6F_R2_stable_official_daily_with_technical_$Stamp"
...
$CriticalPs1 = @(
    "scripts\v18\run_v18_6F_official_daily_with_technical.ps1",
...
$ManifestPath = Join-Path $SnapshotRoot "V18_6F_R2_STABLE_MANIFEST.csv"
$ReadmePath = Join-Path $SnapshotRoot "V18_6F_R2_STABLE_SNAPSHOT_README.txt"
$RestorePath = Join-Path $SnapshotRoot "restore_v18_6F_R2_stable_snapshot.ps1"
...
$RestoreLines += 'Write-Host "=== RESTORE V18.6F-R2 STABLE SNAPSHOT START ==="'
...
$RestoreLines += '    }'
$RestoreLines += '}'
$RestoreLines += 'Write-Host "=== RESTORE V18.6F-R2 STABLE SNAPSHOT DONE ==="'
...
$Readme = @()
$Readme += "V18.6F-R2 STABLE SNAPSHOT README"
$Readme += ""
$Readme += "STATUS:"
$Readme += $StableStatus
$Readme += ""
...
$Readme += ""
$Readme += "PURPOSE:"
$Readme += "Stable snapshot after V18.6F became the official daily wrapper with technical timing."
$Readme += ""
$Readme += "KEY DAILY ENTRY:"
$Readme += 'powershell -NoProfile -ExecutionPolicy Bypass -File "D:\us-tech-quant\scripts\v18\run_v18_6F_official_daily_with_technical.ps1"'
$Readme += ""
$Readme += "KEY CAPABILITIES PRESERVED:"
$Readme += "- V18.4J main final daily read center"
...
$Readme += "- V18.6F official daily wrapper with technical timing"
$Readme += ""
$Readme += "COUNTS:"
...
Write-Host ""
Write-Host "=== V18.6F-R2 STABLE SNAPSHOT READY ==="
...
Write-Host ""
Write-Host "=== V18.6F-R2 STABLE SNAPSHOT DONE ==="
