...
Write-Host "=== V18.23C-R4 CONTROLLED STAGED BACKFILL BATCH 2 START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: CONTROLLED_STAGED_BACKFILL_BATCH2_STAGED_ONLY"
Write-Host "ALLOWED_EXTERNAL_FETCH: yfinance"
...
$Script = Join-Path $Root "scripts\v18\v18_23C_R4_controlled_staged_backfill_batch2.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_23C_R4_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.23C-R4 Batch 2 Python script: $Script"
}
...
Write-Host "=== V18.23C-R4 READ_FIRST CONTENT ==="
...
Write-Host "=== V18.23C-R4 CONTROLLED STAGED BACKFILL BATCH 2 END ==="
exit 0
