...
Write-Host "=== V18.21A-R4 STABLE SNAPSHOT START ==="
...
$Script = Join-Path $Root "scripts\v18\v18_21A_R4_stable_snapshot.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21A_R4_STABLE_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21A_R4_CURRENT_STABLE_SNAPSHOT_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21A-R4 stable snapshot Python script: $Script"
}
...
Write-Host "=== V18.21A-R4 STABLE SNAPSHOT END ==="
