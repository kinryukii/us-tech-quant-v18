...
Write-Host "=== V18.21G CONTROLLED FORWARD OUTCOME FILLER DESIGN START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: ADVISORY_DRYRUN_ONLY"
Write-Host "PATCH_MODE: CONTROLLED_FORWARD_OUTCOME_FILLER_DESIGN_ONLY"
...
$Script = Join-Path $Root "scripts\v18\v18_21G_controlled_forward_outcome_filler_design.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21G_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21G_CURRENT_CONTROLLED_FORWARD_OUTCOME_FILLER_DESIGN_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21G controlled forward outcome filler design Python script: $Script"
}
...
Write-Host "=== V18.21G CONTROLLED FORWARD OUTCOME FILLER DESIGN END ==="
