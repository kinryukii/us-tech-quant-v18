...
Write-Host "=== V18.23B ROLLING SCAN EXECUTOR START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: LOCAL_ONLY_ROLLING_SCAN_EXECUTION"
...
$Script = Join-Path $Root "scripts\v18\v18_23B_rolling_scan_executor.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_23B_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.23B rolling scan executor Python script: $Script"
}
...
Write-Host "=== V18.23B READ_FIRST CONTENT ==="
...
Write-Host "=== V18.23B ROLLING SCAN EXECUTOR END ==="
exit 0
