...
$Script = Join-Path $Root "scripts\v18\v18_48A_top20_options_data_collector.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_48A_READ_FIRST.txt"

Write-Host "DELEGATING_TO: $Script"
Write-Host "PATCH_VERSION: V18.48A"
Write-Host "PATCH_NAME: Top20 Options Data Collector"
