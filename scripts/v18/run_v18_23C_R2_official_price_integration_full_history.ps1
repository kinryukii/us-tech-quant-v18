...
Write-Host "=== V18.23C-R2 OFFICIAL PRICE CACHE INTEGRATION START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: OFFICIAL_PRICE_CACHE_INTEGRATION_FULL_HISTORY_ONLY_WITH_BACKUP"
...
$Script = Join-Path $Root "scripts\v18\v18_23C_R2_official_price_integration_full_history.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_23C_R2_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.23C-R2 integration Python script: $Script"
}
...
Write-Host "=== V18.23C-R2 READ_FIRST CONTENT ==="
...
Write-Host "=== V18.23C-R2 OFFICIAL PRICE CACHE INTEGRATION END ==="
exit 0
