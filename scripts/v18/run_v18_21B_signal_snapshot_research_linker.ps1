...
Write-Host "=== V18.21B SIGNAL SNAPSHOT RESEARCH LINKER START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: ADVISORY_ONLY"
Write-Host "PATCH_MODE: SIGNAL_SNAPSHOT_AND_RESEARCH_LINK_ONLY"
...
$Script = Join-Path $Root "scripts\v18\v18_21B_signal_snapshot_research_linker.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21B_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21B_CURRENT_SIGNAL_SNAPSHOT_RESEARCH_LINKER_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21B Python script: $Script"
}
...
Write-Host "=== V18.21B SIGNAL SNAPSHOT RESEARCH LINKER END ==="
