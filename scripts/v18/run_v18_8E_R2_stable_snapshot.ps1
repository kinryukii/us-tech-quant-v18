...
$SnapshotName = "V18_8E_R2_stable_current_official_daily_with_simulation_$Stamp"
...
$SnapshotReadme = Join-Path $SnapshotRoot "V18_8E_R2_STABLE_SNAPSHOT_README.txt"
$Manifest = Join-Path $SnapshotRoot "V18_8E_R2_STABLE_MANIFEST.csv"
$RestoreScript = Join-Path $SnapshotRoot "restore_v18_8E_R2_stable_snapshot.ps1"

Write-Host ""
Write-Host "=== V18.8E-R2 STABLE SNAPSHOT START ==="
...
$RestoreLines += 'Write-Host "=== RESTORE V18.8E-R2 STABLE SNAPSHOT START ==="'
...
$RestoreLines += '}'
$RestoreLines += ''
$RestoreLines += 'Write-Host "=== RESTORE V18.8E-R2 STABLE SNAPSHOT DONE ==="'
...
$Readme = @()
$Readme += "V18.8E-R2 STABLE SNAPSHOT README"
$Readme += ""
...
$Report = @()
$Report += "# V18.8E-R2 Stable Snapshot Report"
$Report += ""
...
Write-Host ""
Write-Host "=== V18.8E-R2 STABLE SNAPSHOT READY ==="
