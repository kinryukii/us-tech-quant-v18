...
Write-Host "=== V18.21C FACTOR EFFECTIVENESS RESEARCH READ CENTER START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: ADVISORY_ONLY"
Write-Host "PATCH_MODE: FACTOR_EFFECTIVENESS_RESEARCH_READ_CENTER_ONLY"
...
$Script = Join-Path $Root "scripts\v18\v18_21C_factor_effectiveness_read_center.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21C_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21C_CURRENT_FACTOR_EFFECTIVENESS_RESEARCH_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21C Python script: $Script"
}
...
Write-Host "=== V18.21C FACTOR EFFECTIVENESS RESEARCH READ CENTER END ==="
