...
Write-Host "=== V18.23B-R2 WATCHDOG FORCE ELIGIBILITY START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: LOCAL_ONLY_WATCHDOG_FORCE_ELIGIBILITY_GRACE_WINDOW"
...
$Script = Join-Path $Root "scripts\v18\v18_23B_R2_watchdog_force_eligibility_audit.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_23B_R2_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.23B-R2 watchdog Python script: $Script"
}
...
Write-Host "=== V18.23B-R2 READ_FIRST CONTENT ==="
...
Write-Host "=== V18.23B-R2 WATCHDOG FORCE ELIGIBILITY END ==="
exit 0
