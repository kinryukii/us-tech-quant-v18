...
Write-Host "===== START V18.25A-R15 POST-PROMOTION VALIDATION / R1 PATCH ====="
Write-Host "ROOT: $Root"
Write-Host "MODE: READ_ONLY_POST_PROMOTION_VALIDATION_AND_R1_RECOMMENDATION_PATCH"
...
$ScriptPath = Join-Path $Root "scripts\v18\v18_25A_R15_post_promotion_validation_recommendation_patch.py"
$ReadFirstPath = Join-Path $Root "outputs\v18\ops\V18_25A_R15_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $ScriptPath)) {
    throw "Missing V18.25A-R15 Python script: $ScriptPath"
}
...
Write-Host "===== V18.25A-R15 READ_FIRST ====="
...
Write-Host "===== END V18.25A-R15 POST-PROMOTION VALIDATION / R1 PATCH ====="
exit 0
