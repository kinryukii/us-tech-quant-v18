...
Write-Host "=== V18.21I UNIFIED BACKTEST RESEARCH DESIGN START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: ADVISORY_READ_ONLY"
Write-Host "PATCH_MODE: UNIFIED_BACKTEST_RESEARCH_DESIGN_ONLY"
Write-Host "POLICY_APPLIED: FALSE"
Write-Host "UNIFIED_BACKTEST_DESIGN_READY: TRUE"
...
$Script = Join-Path $Root "scripts\v18\v18_21I_unified_backtest_research_design.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21I_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21I_CURRENT_UNIFIED_BACKTEST_RESEARCH_DESIGN_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21I unified backtest research design Python script: $Script"
}
...
Write-Host "=== V18.21I UNIFIED BACKTEST RESEARCH DESIGN END ==="
