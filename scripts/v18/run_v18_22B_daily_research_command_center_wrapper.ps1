...
Write-Host "=== V18.22B DAILY RESEARCH COMMAND CENTER WRAPPER START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: DAILY_RESEARCH_READ_ONLY_WRAPPER"
Write-Host "PATCH_MODE: RESEARCH_COMMAND_CENTER_WRAPPER_INTEGRATION_ONLY"
...
$Script = Join-Path $Root "scripts\v18\v18_22B_daily_research_command_center_wrapper.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_22B_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_22B_CURRENT_DAILY_RESEARCH_COMMAND_CENTER_WRAPPER_REPORT.md"
$Packet = Join-Path $Root "outputs\v18\research_command_center\V18_22B_CURRENT_DAILY_RESEARCH_PACKET.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.22B daily research command center wrapper Python script: $Script"
}
...
Write-Host "DAILY_RESEARCH_PACKET: $Packet"
Write-Host "=== V18.22B DAILY RESEARCH COMMAND CENTER WRAPPER END ==="
