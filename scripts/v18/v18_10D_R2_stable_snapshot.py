...
def build_restore_script(snapshot: Path, restore_path: Path) -> None:
    ...
    lines.append('Write-Host "=== V18.10D-R2 STABLE SNAPSHOT RESTORE ==="')
...
def main() -> int:
    ...
    stamp = now_stamp()
    snapshot_name = f"V18_10D_R2_stable_current_shadow_research_daily_{stamp}"
    ...
    manifest_path = snapshot / "V18_10D_R2_STABLE_MANIFEST.csv"
    readme_path = snapshot / "V18_10D_R2_STABLE_SNAPSHOT_README.txt"
    restore_path = snapshot / "restore_v18_10D_R2_stable_snapshot.ps1"
    check_path = snapshot / "V18_10D_R2_STABLE_VALIDATION_CHECKS.csv"
    combined_rf_path = snapshot / "V18_10D_R2_COMBINED_READ_FIRST_CAPTURE.txt"

    report_path = out_dir / "V18_10D_R2_CURRENT_STABLE_SNAPSHOT_REPORT.md"
    read_first_path = out_dir / "V18_10D_R2_READ_FIRST.txt"
    ...
    critical_ps1 = [
        ...
        "scripts/v18/run_v18_current_shadow_research_daily.ps1",
        "scripts/v18/run_v18_9C_official_daily_with_sim_validation.ps1",
        "scripts/v18/run_v18_10D_official_daily_with_factor_weight_research.ps1",
    ...
    critical_py = [
        "scripts/v18/v18_10D_R2_stable_snapshot.py",
    ...
    key_readfirsts = [
        root / "outputs/v18/read_center/V18_CURRENT_SHADOW_RESEARCH_DAILY_READ_FIRST.txt",
        root / "outputs/v18/read_center/V18_CURRENT_SHADOW_RESEARCH_DAILY.md",
        root / "outputs/v18/read_center/V18_10D_READ_FIRST.txt",
        ...
        root / "outputs/v18/factor_registry/V18_10A_R2_READ_FIRST.txt",
        ...
        root / "outputs/v18/read_center/V18_9C_READ_FIRST.txt",
    ]
    ...
    readme_lines = []
    readme_lines.append("V18.10D-R2 STABLE SNAPSHOT README")
    readme_lines.append("")
    ...
    readme_lines.append("Stable restore point after independent current shadow research daily entry was installed and light-tested.")
    readme_lines.append("")
    readme_lines.append("IMPORTANT:")
    readme_lines.append("run_v18_current_official_daily.ps1 is not replaced by this snapshot.")
    readme_lines.append("run_v18_current_shadow_research_daily.ps1 remains an independent shadow research entry.")
    readme_lines.append("")
    ...
    readme_lines.append("DISABLED")
    readme_lines.append("")
    readme_lines.append("DAILY SHADOW RESEARCH COMMAND:")
    readme_lines.append('powershell -NoProfile -ExecutionPolicy Bypass -File "D:\\us-tech-quant\\scripts\\v18\\run_v18_current_shadow_research_daily.ps1" -UseYFinance')
    readme_lines.append("")
    ...
    report_lines = []
    report_lines.append("# V18.10D-R2 Stable Snapshot")
    report_lines.append("")
    ...
    report_lines.append("- MODE: `STABLE_RESTORE_POINT_FOR_CURRENT_SHADOW_RESEARCH_DAILY_ENTRY`")
    ...
    read_first = f"""V18.10D-R2 STABLE SNAPSHOT READ FIRST

STATUS:
{status}

MODE:
STABLE_RESTORE_POINT_FOR_CURRENT_SHADOW_RESEARCH_DAILY_ENTRY
...
CURRENT_OFFICIAL_DAILY_REPLACED:
NO

SHADOW_RESEARCH_ENTRY:
D:\\us-tech-quant\\scripts\\v18\\run_v18_current_shadow_research_daily.ps1

DAILY_SHADOW_RESEARCH_COMMAND:
...
NEXT_STEP:
Use run_v18_current_shadow_research_daily.ps1 as the enhanced daily research entry.
Do not replace run_v18_current_official_daily.ps1 unless separately approved.
...
"""
    ...
    print("")
    print("=== V18.10D-R2 STABLE SNAPSHOT READY ===")
    print(f"STATUS: {status}")
    print("MODE: STABLE_RESTORE_POINT_FOR_CURRENT_SHADOW_RESEARCH_DAILY_ENTRY")
    ...
    print("CURRENT_OFFICIAL_DAILY_REPLACED: NO")
