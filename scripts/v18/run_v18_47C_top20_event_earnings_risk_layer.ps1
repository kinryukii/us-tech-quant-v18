...
$Script = Join-Path $Root "scripts\v18\v18_47C_top20_event_earnings_risk_layer.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_47C_READ_FIRST.txt"

Write-Host "DELEGATING_TO: $Script"
Write-Host "PATCH_VERSION: V18.47C"
Write-Host "PATCH_NAME: Top20 Event / Earnings Risk Layer"
