...
$SnapshotName = "V18_4J_R2_stable_final_daily_read_center_$Stamp"
$SnapshotRoot = Join-Path $Root "archive\stable\$SnapshotName"

$ManifestPath = Join-Path $SnapshotRoot "V18_4J_R2_STABLE_MANIFEST_$Stamp.csv"
$ReadmePath = Join-Path $SnapshotRoot "V18_4J_R2_STABLE_READ_FIRST.txt"
$RestorePath = Join-Path $SnapshotRoot "restore_v18_4J_R2_stable_snapshot.ps1"

Write-Host ""
Write-Host "=== V18.4J-R2 STABLE SNAPSHOT START ==="
...
$CriticalPS = @()
$CriticalPS += "scripts\v18\run_v18_4J_R1_final_daily_read_center_wrapper.ps1"
$CriticalPS += "scripts\v18\run_v18_4J_read_center_cleanup.ps1"
...
$RestoreLines += 'Write-Host "=== RESTORE V18.4J-R2 STABLE SNAPSHOT START ==="'
...
$RestoreLines += '}'
$RestoreLines += 'Write-Host ""'
$RestoreLines += 'Write-Host "=== RESTORE V18.4J-R2 STABLE SNAPSHOT DONE ==="'
$RestoreLines += 'Write-Host "FINAL DAILY COMMAND:"'
$RestoreLines += 'Write-Host ''powershell -NoProfile -ExecutionPolicy Bypass -File "D:\us-tech-quant\scripts\v18\run_v18_4J_R1_final_daily_read_center_wrapper.ps1"'''
...
$ReadmeLines = @()
$ReadmeLines += "V18_4J_R2_STABLE_SNAPSHOT_CREATED"
$ReadmeLines += "GENERATED_AT: $(Get-Date -Format "yyyy-MM-dd HH:mm:ss")"
$ReadmeLines += "SNAPSHOT: $SnapshotRoot"
$ReadmeLines += ""
$ReadmeLines += "SCOPE:"
$ReadmeLines += "V18.4J-R1 final daily read center wrapper"
$ReadmeLines += "V18.4J read center cleanup"
$ReadmeLines += "V18.4I-R1 integrated final daily promotion merge"
...
$ReadmeLines += "V18 current outputs, V17 outputs, and state files"
$ReadmeLines += ""
$ReadmeLines += "FINAL_DAILY_COMMAND:"
$ReadmeLines += 'powershell -NoProfile -ExecutionPolicy Bypass -File "D:\us-tech-quant\scripts\v18\run_v18_4J_R1_final_daily_read_center_wrapper.ps1"'
$ReadmeLines += ""
$ReadmeLines += "PRIMARY_READ_FILE:"
$ReadmeLines += "D:\us-tech-quant\outputs\v18\read_center\V18_CURRENT_READ_FIRST.md"
$ReadmeLines += ""
...
Write-Host ""
Write-Host "=== V18.4J-R2 STABLE SNAPSHOT READY ==="
Write-Host "SNAPSHOT:" $SnapshotRoot
...
if ($CopyFail.Count -gt 0 -or $MissingCritical.Count -gt 0 -or $ParseFail.Count -gt 0) {
    throw "V18.4J-R2 stable snapshot completed with errors. Check README."
}

Write-Host ""
Write-Host "=== V18.4J-R2 STABLE SNAPSHOT DONE ==="