...
Write-Host "=== V18.25A DEGRADED DAILY OUTPUT CONTROLLER START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: READ_ONLY_DEGRADED_DAILY_OUTPUT_CONTROLLER"
...
$Script = Join-Path $Root "scripts\v18\v18_25A_degraded_daily_output_controller.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_25A_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.25A degraded daily output controller Python script: $Script"
}
...
Write-Host "=== V18.25A READ_FIRST CONTENT ==="
...
Write-Host "=== V18.25A DEGRADED DAILY OUTPUT CONTROLLER END ==="
exit 0
