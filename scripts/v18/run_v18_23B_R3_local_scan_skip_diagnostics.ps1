...
Write-Host "=== V18.23B-R3 LOCAL SCAN SKIP DIAGNOSTICS START ==="
Write-Host "ROOT: $Root"
Write-Host "MODE: READ_ONLY_LOCAL_SCAN_SKIP_DIAGNOSTICS"
...
$Script = Join-Path $Root "scripts\v18\v18_23B_R3_local_scan_skip_diagnostics.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_23B_R3_READ_FIRST.txt"

if (-not (Test-Path -LiteralPath $Python)) {
    $Python = "python"
}
if (-not (Test-Path -LiteralPath $Script)) {
    throw "Missing V18.23B-R3 diagnostics Python script: $Script"
}
...
Write-Host "=== V18.23B-R3 READ_FIRST CONTENT ==="
...
Write-Host "=== V18.23B-R3 LOCAL SCAN SKIP DIAGNOSTICS END ==="
exit 0
