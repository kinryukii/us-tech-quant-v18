...
Write-Host "=== V18.21F STABLE SNAPSHOT START ==="
...
$Script = Join-Path $Root "scripts\v18\v18_21F_stable_snapshot.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21F_STABLE_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21F_CURRENT_STABLE_SNAPSHOT_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21F stable snapshot Python script: $Script"
}
...
Write-Host "=== V18.21F STABLE SNAPSHOT END ==="
