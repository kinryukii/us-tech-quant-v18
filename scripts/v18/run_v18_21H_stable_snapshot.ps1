...
Write-Host "=== V18.21H STABLE SNAPSHOT START ==="
...
$Script = Join-Path $Root "scripts\v18\v18_21H_stable_snapshot.py"
$ReadFirst = Join-Path $Root "outputs\v18\ops\V18_21H_STABLE_READ_FIRST.txt"
$Report = Join-Path $Root "outputs\v18\ops\V18_21H_CURRENT_STABLE_SNAPSHOT_REPORT.md"

if (-not (Test-Path $Python)) {
    $Python = "python"
}
if (-not (Test-Path $Script)) {
    throw "Missing V18.21H stable snapshot Python script: $Script"
}
...
Write-Host "=== V18.21H STABLE SNAPSHOT END ==="
